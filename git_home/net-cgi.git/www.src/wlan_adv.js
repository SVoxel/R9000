...
/*	if( wps_progress_status == "2" || wps_progress_status == "3" || wps_progress_status == "start" )
	...
	if(form.rts.value == "" || form.rts_an.value == "" || form.rts_ad.value == "")
	{	
		alert("$rts_range");
		return false;
	}
        if(!(form.rts.value > 0 && form.rts.value <= 2347) || !(form.rts_an.value > 0 && form.rts_an.value <= 2347)
		|| !(form.rts_ad.value > 0 && form.rts_ad.value <= 2347))
        {
                alert("$rts_range");
                return false;
        }
	...
	if(form.frag.value == "" || (form.frag_an.value == "" && top.fragment_an_flag == 1)
		|| form.frag_ad.value == "" && top.fragment_ad_flag == 1)
	{
	...
	if(!(form.frag.value > 255 && form.frag.value < 2347) || (!(form.frag_an.value > 255 && form.frag_an.value < 2347) && top.fragment_an_flag == 1)
		|| (!(form.frag_ad.value > 255 && form.frag_ad.value < 2347) && top.fragment_ad_flag == 1))
	{
		alert("$fragmentation_range");
		return false;
	}
	...
	if(form.wmm_enable_ad.checked == true)
		form.wladv_endis_wmm_ad.value = "1";
	else
		form.wladv_endis_wmm_ad.value = "0";

	if(form.enable_shortpreamble.selectedIndex == "2") //Preamble Mode bgn
        ...
        if(form.enable_shortpreamble_an.selectedIndex == "2") //an
	...
	if(form.enable_shortpreamble_ad.selectedIndex == "2") //ad
		form.wig_enable_shortpreamble.value = "2";
	else if(form.enable_shortpreamble_ad.selectedIndex == "1")
		form.wig_enable_shortpreamble.value = "1";
	else if(form.enable_shortpreamble_ad.selectedIndex == "0")
		form.wig_enable_shortpreamble.value = "0";
	...
	if(form.enable_ap_ad.checked == true)
	...
	if(form.wsc_config.checked == true)
	{
		...
		form.endis_wsc_config_ad.value="5";
	}
	else
	{
		form.endis_wsc_config.value="1";
		form.endis_wsc_config_a.value="1";
		form.endis_wsc_config_ad.value="1";
	}
	...
	form.rts_ad.value=port_range_interception(form.rts_ad.value);
	...
	form.wig_rts.value = form.rts_ad.value;
	...
	if(top.fragment_ad_flag == 1){
		form.frag_ad.value=port_range_interception(form.frag_ad.value);
		form.wig_frag.value = form.frag_ad.value;
	}
	...
	if(form.tx_power_ctrl_ad.value == "super_wifi")
		form.tx_power_ctrl_ad.value = wla_tpscale;
	form.submit();
	//return true;
}
