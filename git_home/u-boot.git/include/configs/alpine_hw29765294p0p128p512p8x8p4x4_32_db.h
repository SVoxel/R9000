#ifndef __AL_ALPINE_HW29765294P0P128P512P8X8P4X4_32_DB_H
#define __AL_ALPINE_HW29765294P0P128P512P8X8P4X4_32_DB_H
...
#define NAND_PT_SIZE "0x7000000\0"
...
#define CONFIG_AL_NAND_ENV_COMMANDS					\
	...
	"nand_pt_addr_kernel=0x05100000\0"				\
	"nand_pt_size_kernel=0x02c40000\0"				\
...
#define CONFIG_HW29765294P0P128P512P8X8P4X4

#define DNI_NAND
#define CONFIG_SYS_FLASH_SECTOR_SIZE 0x20000

#define FIRMWARE_RECOVER_FROM_TFTP_SERVER 1
#define CONFIG_SYS_IMAGE_LEN   0x02c40000
#define CONFIG_SYS_IMAGE_BASE_ADDR  0x05100000
...
#define CONFIG_SYS_FLASH_CONFIG_BASE  0x00980000
...
#define LAN_PHY_RESET_GPIO  45  /* reset 88E6190 (Output pin/Active HIGH) */
#define WAN_PHY_RESET_GPIO  46  /* reset 88E1518 (Output pin/Active HIGH) */
...
#define CONFIG_SYS_STRING_TABLE_TOTAL_LEN          0x380000   /* Totally allocate 2000KB in UBI volume to save all string tables */
	#define CONFIG_SYS_STRING_TABLE_PARTITION_NAME     "language"         /* Partition which contains UBI volume below */
	#define CONFIG_SYS_STRING_TABLE_BASE_ADDR          0x600000	
