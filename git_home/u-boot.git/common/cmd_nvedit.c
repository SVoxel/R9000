...
ulong getenv_ulong(const char *name, int base, ulong default_val)
{
    ...
    (!defined(CONFIG_ENV_IS_NOWHERE) || \
        defined(CONFIG_HW29765235P0P512P1024P4X4P4X4) || \
...
#endif
	"env set [-f] name [arg ...]\n"
	"env setmem name <address>\n"
	"env inc name <inc val (hex)>\n";
#endif
...
U_BOOT_CMD_COMPLETE(
	setenvmem, CONFIG_SYS_MAXARGS, 0, do_env_set_from_mem,
