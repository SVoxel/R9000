...
function setGray(cf,click,hour_24_flag)
{
	if(cf.email_notify.checked)
	{
		...
		cf.cloud_noti.disabled = false;
		cf.usb_backup_noti.disabled = false;
	}
	else
	{
		...
		cf.cloud_noti.disabled = true;
		cf.usb_backup_noti.disabled = true;
...
function check_email(cf,hour_24_flag)
{
	...
	if(cf.cloud_noti.checked == true)
		cf.cloud_email_noti_hid.value = "1";
	else
		cf.cloud_email_noti_hid.value = "0";
	if(cf.usb_backup_noti.checked == true)
