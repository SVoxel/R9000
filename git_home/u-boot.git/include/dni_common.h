...
#if defined(WORKAROUND_ANNAPURNA_AL314_GMAC_NMRP_HANG)
#define workaround_annapurna_al314_gmac_nmrp_hang_action()  do {  \
	DECLARE_GLOBAL_DATA_PTR;  \
	eth_halt();  \
	eth_init(gd->bd);  \
} while (0)
#else
#define workaround_annapurna_al314_gmac_nmrp_hang_action()  do {} while (0)
#endif
