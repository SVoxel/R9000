...
struct ipv6_pass_dev {
        int enable;
        void (*pass_receive)(struct sk_buff *);
};
 ...
 */
	...
	/* DNI : do not free / clone the packet */
	rx_handler_func_t __rcu	*early_rx_handler;
	void __rcu		*early_rx_handler_data;
	/* DNI : end */
