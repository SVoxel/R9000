 ...
 * #define CONFIG_RUMI
 */
#if !defined(DO_DEPS_ONLY) || defined(HW29764958P0P128P512P3X3P4X4_DO_SOC_DEPS_ONLY)
/*
...
#endif
#if !defined(HW29764958P0P128P512P3X3P4X4_DO_SOC_DEPS_ONLY)
...
#define DNI_NAND
#define CONFIG_HW29764958P0P128P512P3X3P4X4
...
#define CONFIG_SYS_FLASH_CONFIG_PARTITION_NAME     "dnidata"  /* Partition which contains UBI volume below */
#define CONFIG_SYS_FLASH_CONFIG_UBI_VOL_NAME       "config"   /* configuration is actually stored in this UBI volume */
...
#define CONFIG_SYS_STRING_TABLE_UBI_VOL_NAME       "language_volume"  /* Language tables are actually stored in this UBI volume */
#define CONFIG_RESERVED_LEN  0x4880000  /* blocked by "pot" UBI volume in "dnidata" partition */
#endif

#define MTDIDS_DEFAULT    "nand0=msm_nand"
#define MTDPARTS_DEFAULT \
		"mtdparts=msm_nand:3584K@0x7980000(" CONFIG_SYS_STRING_TABLE_PARTITION_NAME ")" \
		                 ",3M@0x7d00000(" CONFIG_SYS_FLASH_CONFIG_PARTITION_NAME ")"
...
#ifndef __ASSEMBLY__
#include <compiler.h>
#include "../../board/qcom/hw29764958p0p128p512p3x3p4x4/ipq806x_cdp.h"
 ...
 * struct arrays in
 * board/qcom/hw29764958p0p128p512p3x3p4x4/ipq806x_board_param.h
 */
...
/*
 * R7500 hardware's PCB number is 29764841, 0MiB NOR Flash, 128MiB NAND Flash,
 * 256MiB RAM, 3Tx 3Rx 2.4GHz radio, 4Tx 4Rx 5GHz radio.
 * It's HW_ID would be "29764841+0+128+256+3x3+4x4".
 * "(8 MSB of PCB number)+(NOR flash size)+(NAND flash size)+(SDRAM size)+
 *  (2.4GHz radio)+(5GHz radio)", length should be 26
 */
...
/*
 * FIXME:
 *     "ubi_prepare": Use a better method to check whether UBI device is
 *                    attached.
 */
#define CONFIG_EXTRA_ENV_SETTINGS					\
	"ethact=eth1\0"							\
	"updateloader=ipq_nand sbl && nand erase 0x00c80000 0x00580000 && "	\
	"imgaddr=0x42000000 && source $imgaddr:script\0"	\
	"config_ubi_prepare=mtdparts default; ubi part " \
			CONFIG_SYS_FLASH_CONFIG_PARTITION_NAME "\0"	\
	"language_ubi_prepare=mtdparts default; ubi part " \
			CONFIG_SYS_STRING_TABLE_PARTITION_NAME "\0"	\
	""
