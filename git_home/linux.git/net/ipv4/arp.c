...
int ipmac_read(struct file *file, char __user *buf,
...
int ipmac_write(struct file *file, const char __user *buf,
						size_t count, loff_t *ppos)
{
       char line[64];
...
static const struct file_operations proc_ipmac_operations = {
	.read		= ipmac_read,
	.write		= ipmac_write,
};

void create_ipmac_proc_entry()
{
       proc_create(IPMAC_PROC_NAME, 0666, NULL, &proc_ipmac_operations);
