...
function login_type_show(cf)
{
	...
	var ipv6_auto_detect = top.ipv6_auto_detect;
	var ipv6_dhcp_flag = top.ipv6_dhcp_flag;
	var ipv6_pppoe_flag = top.ipv6_pppoe_flag;
	var ipv6_items = new Array("disabled", "$pppoe2_disable", "autoDetect", "$ipv6_auto_detect", "autoConfig", "$ipv6_auto_config", "6to4", "$ipv6_6to4_tunnel", "6rd", "6rd", "bridge", "$ipv6_pass_through", "fixed", "$ipv6_fixed", "dhcp", "$router_status_dhcp", "pppoe", "$basic_intserv_pppoe", "orange", "Orange France");
	var len = 0;
