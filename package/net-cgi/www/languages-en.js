...
network_employee="Use this network for employee access to the Internet.  When using this network, you cannot see other devices that are connected and you cannot access the local area network (LAN)."
