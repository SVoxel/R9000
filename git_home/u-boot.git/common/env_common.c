...
#ifndef CONFIG_DISPLAY_USING_DEFAULT_ENV_DISABLED
...
#if defined(CONFIG_HW29765235P0P512P1024P4X4P4X4) || \
    defined(CONFIG_HW29765294P0P128P512P8X8P4X4)
		crc_ok = crc32(0, ep->data, ENV_SIZE) == crc;

		if (!crc_ok && (ENV_SIZE == (SZ_16K - ENV_HEADER_SIZE))) {
			memset(ep->data + (SZ_8K - ENV_HEADER_SIZE), 0, SZ_8K);
			crc_ok = crc32(0, ep->data, (SZ_8K - ENV_HEADER_SIZE)) == crc;
		}
