...
function checkStaticIP()
{
	...
	cf.preferred_dns.value == "..."? cf.preferred_dns.value = "" : cf.preferred_dns.value;
	cf.alternate_dns.value == "..."? cf.alternate_dns.value = "" : cf.alternate_dns.value;
	cf.third_dns.value == "..."? cf.third_dns.value = "" : cf.third_dns.value;
	cf.submit();
