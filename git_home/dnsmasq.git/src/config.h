...
/*
 * DNI DNSMASQ config.h
 */
#ifndef _DNI_DNSMASQ_CONFIG_H
#define _DNI_DNSMASQ_CONFIG_H
...
/*
 * define DNI_PARENTAL_CTL to support Parental Control feature
 * If Parental Control is enabled, any dns query should be sent to 208.67.222.222 or 208.67.202.202,
 * and a suffix like as "OpenDNS<DeviceID>" should be added to the tail of this packet.
 * <DeviceID> is a specific number related with diffrent MACaddr.
 */
#define DNI_PARENTAL_CTL 1

/*
 * define SUP_STATIC_PPTP to support static pptp for Russian Version
 */
#define SUP_STATIC_PPTP 1

/*
 * define USBSHARE_DOMAIN_SUPPORT to resolve "readyshare.routerlogin.net" and "readyshare.routerlogin.com" to Router LAN IP
 */
#define USBSHARE_DOMAIN_SUPPORT 1
 ...
 */
/* #undef DNI_IPV6_FEATURE */

/*
 * define BIND_SRVSOCK_TO_WAN to bind server socket to WAN interface
 */
#define BIND_SRVSOCK_TO_WAN 1
