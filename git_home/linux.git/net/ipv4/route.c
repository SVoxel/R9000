...
/* ip_rt_send_first_redirect_anyway:
...
void ip_rt_send_redirect(struct sk_buff *skb)
{
	...
	struct net *net;
	int log_martians;
	int send_first_redirect_anyway = ip_rt_send_first_redirect_anyway;
	 ...
	 * redirect.
	 */
	if ((send_first_redirect_anyway &&
			!(rt->dst.flags & DST_FIRST_REDIRECTED)) ||
			peer->rate_tokens == 0 ||
			time_after(jiffies,
		       (peer->rate_last +
