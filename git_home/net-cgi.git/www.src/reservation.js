function check_reservation_add(cf,flag)
{
	...
	{ 
		if(isValidChar_space(cf.dv_name.value.charCodeAt(i))==false)
		{
...
function data_select(num)
{
	...
	if( show_name_array[num] == "<unknown>" || show_name_array[num] == "&lt;unknown&gt;" )
		...
		cf.dv_name.value=show_name_array[num].replace(/&#92;/g, "\\").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&#40;/g,"(").replace(/&#41;/g,")").replace(/&#34;/g,'\"').replace(/&#39;/g,"'").replace(/&#35;/g,"#").replace(/&#38;/g,"&");
