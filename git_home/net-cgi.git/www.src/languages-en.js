...
lacp_head="Ethernet Port Aggregation"
lacp_status="Ethernet Port Aggregation Status"
lacp_enable="Enable (LACP- IEEE 802.3ad)"
lacp_inactive="Inactive"
lacp_active="Active"
...
plex_media_ser="Plex Media Server"
plex_tip="Use Plex to manage your media (photos, music, videos) and stream them to all of your devices."
plex_enable="Enable Plex Media Server"
plex_usb_media="USB Device for Plex Data Directory"
plex_no_usb_con="No USB Device Connected"
plex_con_usb="Connect USB Device"
plex_usb_con="USB Device Connected"
plex_start="Start Using Plex"
plex_multi_usb="Multiple USBs Available"
plex_restart="If you change the USB device, Plex will restart.Do you want to proceed with this change?"
plex_ver_up="Plex Version Update"
plex_auto_up="Enable Automatic Plex New Version Update"
plex_wait_down="Please make sure your Internet connection is available, and wait for downloading the binary."
plex_cur_ver="Current Plex version:"
plex_newest="Your Plex Media Server version is up to date."
plex_new="New Plex version:"
plex_ask_up="A new Plex version is available. Do you want to update?"
plex_net_down="The Internet connection is down, please connect to the Internet and wait for checking for the new version."
plex_resel="Your selected USB Drive is removed.Please select new USB Drive for Plex Media Files."
plex_cur_usb="Current USB Device: "
plex_not_found="No USB Device found. Please connect USB Device to router."
plex_change_cur="Change Current USB Device"
plex_sel_usb="Please select a USB Device for storing media files."
plex_continue="If you proceed with the update, your Plex Media Server will restart.Do you want to continue with the update?"
plex_updating="Updating…"
plex_help="<body bgcolor=#0099cc><p><font size=4><b>Plex Media Server Help</b></font></p><a name=ip_tag></a><p>Plex Media Server manages your music, video, and photos that are stored on a locally attached USB storage drive, and streams these media files to your devices, such as desktop computers, mobile phones, and tablets.</p><p>These devices can be connected to your router remotely or locally. To connect to your router locally, use a wired Ethernet connection or WiFi connection.</p><p>Plex Media Server is disabled by default. </p><p>If Plex does not detect that a USB storage drive is attached to the router, Plex is unavailable until a drive is attached.</p><p>If multiple USB storage drives are attached, you can designate one USB drive for use by the Plex Media Server to store and keep the media files and their associated metadata files.</p><p>The router periodically checks for new Plex binary version updates when new features or bug fixes are available. If a new version is found, you must log in to the router and manually update the Plex Media Server to the new version.</p><p>If you enable the automatic update, when a new binary version update is available, the router automatically performs the update at 3:00 a.m. This allows for fewer disruptions while you are streaming media during other hours.</p><p>Note that Plex Media Server restarts after the new version update or after the USB storage drive is changed.</p><p>Your router supports a NAS-based local network drive using the Samba protocol for the Plex media libraries. Follow the router GUI to add a network connection. The connection displays on the Plex Media Server page. Check with your network drive manufacturer for instructions about sharing a folder to other network devices.</p><p>You must use a USB 3.0 storage device for Plex metadata and configuration files. The USB storage device must have at least 5 GB of space.</p></body>"
plex_up_succ="Update binary successfully."
plex_check_fail="Check binary fail."
plex_no_file="No file name."
plex_down_fail="Download fail."
plex_size_fail="Check size fail."
plex_same="Same version, no need upgrade."
plex_not_exist="File not exist."
plex_stop_fail="Stop plex fail."
plex_unzip_fail="Unzip fail."
plex_start_fail="Start plex fail."
plex_unknow="Unknow error."
plex_very_ver="This version is being verified by NETGEAR. Wait while we verify this version."
plex_down_succ="Binary downloaded successfully."
plex_update_now="Update Now"
plex_upgrading="Upgrading..."
plex_checking="Checking…"
plex_downloading="Downloading"
plex_down_enable="Download and enable Plex Media Server"
plex_open="Open Plex"
plex_total="Total space: "
plex_5g_space="We strongly suggest that you reserve at least 5 GB of disk space on your Plex USB device. This ensures good video streaming quality, especially when transcoding is required."
plex_200m_space="Your current USB free size is less than 200 MB. Clear space on your Plex USB device to prevent issues with media play."
plex_free="Free space: "
plex_not_ntp="NTP time is not ready. Make sure that your Internet is ready. "
plex_check_int="Check Internet connection"
plex_rebuild_button="Your Plex database encountered issues. To fix the issues, click the <b>Rebuild Database</b> button."
plex_apply_again="Plex has some issues, please click Apply button to enable the Plex again."
plex_rebuild_confirm="Your Plex database will be rebuilt.<br>Do you want to proceed?<br><br>(<b>WARNING</b>: If you proceed, all the media files that you added to your Plex Media Server will be removed.)"
plex_max_nas="You added the maximum number of network drives."
plex_get_code="To get three Months Free Plex pass promotion code click <a onclick='get_pcode()'>here</a>"
plex_get_code_no_pop="To get 3 Months Free Plex pass  promotion code"
plex_code_to_pop="(Click promotion code to go directly to Plex sign up page)"
plex_nas_title="Add Network Drive Connection from Local Network for the Plex Media Library"
plex_con_name="Connection Name"
plex_select_device="Select an attached device"
plex_example="(For example, /Media/Movies)"
plex_drop_tip="Select An Attached Device"
plex_folder="Folder Name"
plex_incorrect_err="Your router can't connect to your network drive because your network drive credentials are incorrect."
plex_not_support_err="Your router can't connect to your network drive because your network drive system doesn't support the device file system."
plex_address_err="Your router can't connect to your network drive because the device or address you entered does not exist."
plex_folder_err="Your router can't connect to your network drive because you might have entered the wrong folder name."
plex_network_err="Your router can't connect to your network drive because of network errors."
plex_firmwall_err="Your router can't connect to your network drive. Check the network drive firewall settings, Samba server availability, and the login system."
plex_select_drive="Select a network drive."
plex_invalid_folder="Invalid folder name. Folder name can not contain these characters \\:*?<>|\" and can not be blank."
plex_invalid_name="Connection name cannot be blank and can use only numbers, letters, hyphens, and underlines."
plex_multi_name="Duplicate of Connection Name."
plex_folder_added="The folder has been added."
plex_rebuild_success="The database was rebuilt successfully."
plex_rebuild_fail="The attempt to rebuild the database failed."
plex_log_option="Plex Media Server log"
amz_log_new="Back up the router's local USB content onto Amazon Drive Cloud.<br><B>New users,</B> sign up <a onclick='getFree();'>here</a> for six months free.<br>Start your six-month free trial using the promotion code at checkout.<br>Get your promotion code <a onclick='get_pcode()'>here</a>. <span id='pcode'></span><br><br><B>Existing users,</B> log-in <a onclick='doRedirect();'>here</a>"
amz_log_exi="Backup the router's local USB content onto Amazon Drive Cloud<br><B>Log-in or Sign-up</B> <a onclick='doRedirect();'>here</a>."
amz_using_acc="Log in using your Amazon.com account to access your Amazon Drive Cloud."
amz_no_acc="Do not have an Amazon account?"
amz_cre_acc="Create Account"
amz_learn_mo="Learn more about Amazon Drive Cloud >>"
amz_auth="Authenticating..."
amz_not_find="Oops, we could not find an account with the email and password that you entered."
amz_log_succ_l="You successfully logged in to Amazon Drive Cloud!"
amz_close="You will be redirected to the backup view in a few seconds and this window will close."
amz_switch_acc="Switch Account"
amz_acc="Account"
amz_your_acc="Your Amazon Drive Cloud account is: "
amz_set_noti="Set Up Email Notifications"
amz_sel_tip="Select a folder or whole drive that you want to back up to the Cloud"
amz_choose="Choose what you want to back up"
amz_sta="USB Status"
amz_checking="Checking..."
amz_sel_fold="<a class='linktype' onclick='submit_seldir();'>Select Folder or Whole Drive</a> to Back Up"
amz_chg_fold="<a class='linktype' onclick='submit_seldir();'>Change Folder or Whole Drive</a> to Back Up"
amz_bak_now="Back Up Now"
amz_bak_real="<b>Real-time sync</b>-When changes are made to the USB, its contents are automatically backed up to the Cloud."
amz_bak_sche="Back up on schedule"
amz_mon="Mon"
amz_tue="Tue"
amz_wed="Wed"
amz_thu="Thu"
...
amz_sat="Sat"
amz_sun="Sun"
amz_complete="Success! Backup complete."
amz_failed="Backup failed."
amz_error="Error Details >>"
amz_syncing="Sync in progress ..."
amz_usb_chg="It seems that your USB device was  modified or periodically detached from the router. What would you like to do?"
amz_rec="Recover files from Amazon Drive Cloud"
amz_del="Delete files on Amazon Drive Cloud"
amz_bak_noti="<b>Cloud Backup Notification:</b> Send email message when the backup job experiences problems (backup failure, USB device errors)."
amz_resel_del="Reselet folder to back up and delete the back up data on the Cloud."
amz_resel_bak="Reselet folder to back up only."
amz_bad="Bad request. Please try again."
amz_unauth="Unauthorized. Please try again."
amz_forbid="Forbidden. Please try again."
amz_not_found="Not found. Please try again."
amz_not_allow="Method not allowed. Please try again."
amz_conflict="Conflict! Please try again."
amz_request="Too many requests. Please try again."
amz_inter_err="Internal server error. Please try again."
amz_serv_err="Service unavailable. Please try again."
amz_log_fail="Login Failed. Please try again."
amz_get_free="Get Six Months Free"
amz_exi_acc="Use an existing Amazon Drive Cloud account >>"
amz_log_succ_s="Log In Successful"
amz_data_exist="The system detected that folder backup data exists on the Cloud. What would you like to do?"
amz_rename="Rename it and preserve the data"
amz_write="Overwrite it"
amz_down_noti="Download Task Notification: Send email message when download is finished."
amz_pre_data="Previous Folder Backup Data Detected"
amz_real_bak="<B>Real-time backup:</B> Changes are automatically backed up to the cloud"
amz_sche_bak="Scheduled backup"
amz_cloud_low="Cloud Backup"
amz_sel_sche="Select Backup Schedule"
amz_cloud_up="CLOUD BACKUP"
amz_log_h_n="<body bgcolor=#0099cc><p><font size=4><B>Cloud Backup Help</B></font></p><p><B>New users, sign up here for 6 months free:</B> If you don't have the Amazon Drive Cloud accounts, you could get 6 months free accounts by clicking the link and follow the Amazon Drive Cloud webpage.</p><p><B>Existing users, log-in here:</B> If you already have Amazon Drive Cloud accounts, please click this link to login to your account.</p></body></html>"
amz_log_h_e="<body bgcolor=#0099cc><p><font size=4><B>Cloud Backup Help</B></font></p><p><B>Log-in or Sign-up here:</B> If you already have Amazon Drive Cloud accounts, please click this link to login to your account or signup here.</p></body></html>"
amz_cloud_h="<body bgcolor=#0099cc><p><font size=4><B>Cloud Backup Help</B></font></p><p><B>Apply Button:</B> Click the Apply button to save any changes made to this page.</p><p><B>Cancel button:</B> Click the Cancel button to return to the previous settings.</p><p><B>Switch Account button:</B> Click the Switch Account button to log out of your current account and return to the log in page.</p><p><b>Your Amazon Drive Cloud account is:</B> This section shows your account name.</p><p><B>Set Up Email Notifications:</B> Click this link to go to manage your email notifications.</p> <p><B>USB Status: Connected | USB Status: Disconnected:</B> The USB status shows the current connection status of your USB device.</p><p><B>Select folder to back up:</B> Select a folder on your USB device that you want to back up to the Cloud.</p><p><B>Change Folder to back up:</B> After you select a folder, you can click the Change Folder link to change the folder.</p><p><B>Backup Now button:</B> Click the Backup Now button to backup immediately.</p><p><B>Select Backup Schedule:</B></p><ul><li><B>Real-time sync:</B> The default backup schedule is real-time sync, which means that whenever the data on your USB device changes, it is backed up to cloud in real time.</li><li><B>Backup on schedule:</B> Back up on schedule means you can select the day and time to back up your data to the cloud.</li></ul><p><b>Success! Backup Complete:</B> This message notifies you that the last backup job completed successfully.</p><p><B>Backup Failed Error Details >>:</B> This message notifies you that the last backup job failed. For more information, click Error Details.</p></body></html>"
amz_discon="Disconnected"
amz_file_bak="Files to be backed up: "
amz_fold_bak="Folders to be backed up: "
amz_err_mess="Error Messages"
amz_not_code="Not enough promotion code"
amz_net_err="Network error"
amz_invalid="Invalid serial number"
amz_any_err="Any other error"
amz_not_space="Your cloud drive does not have enough space.<br/>Clear your cloud drive to free some space, or decrease the size of your upload files.<br/>After you are done, click the \"Apply\" button to back up again."
amz_con="Connected"
amz_failed_con="Failed to connect to Amazon Drive Cloud. Try again."
amz_logout="Do you really want to log out?"
amz_do_no="Do nothing"
amz_apply_tip="You must click the Apply button."
amz_one_day="Make sure to check your backup at least once a day."
amz_invalid_link="Invalid Folder Link"
amz_invalid_fold="[Cloud Backup] You selected an invalid folder."
amz_usb_removed="[Cloud Backup] Your USB was removed during the backup."
amz_folder_invalid="The folder that you selected is invalid."
amz_no_quota="Amazon Cloud Server did not respond to the quota request. Wait a second, then click the <b>Apply</b> button to try again."
amz_read_only="Your hard disk is read-only."
amz_not_access="Your hard disk is not accessible."
amz_not_disk="You did not select a hard disk."
amz_not_folder="You did not select a backup folder."
amz_no_rootid="Amazon Cloud Server did not respond to the rootid request. Wait a second, then click the <b>Apply</b> button to try again."
amz_no_respon="Amazon Cloud Server did not respond. Wait a second, then click the <b>Apply</b> button to try again."
amz_failed_delete="Amazon Cloud Server failed to delete conflict folder. Wait a second, then click the <b>Apply</b> button to try again."
amz_failed_create="Amazon Cloud Server failed to create a backup folder. Wait a second, then click the <b>Apply</b> button to try again.."
amz_failed_list="Failed to list local file information."
amz_log_option="Amazon Cloud backup log"
...
thank_login_info="Thank you for purchasing Netgear's R9000 Wireless-N Router. Be sure to use the Firmware Upgrade periodically to take advantage of improvements and feature additions NETGEAR offers for this product.<BR><BR>To take advantage of the Wireless-N feature offered by the router, use a wireless adapter that displays this logo."
thank_login_info_RangeMax="Thank you for purchasing Netgear's R9000 RangeMax (TM) Wireless-N 600 Router. Be sure to use the Firmware Upgrade periodically to take advantage of improvements and feature additions NETGEAR offers for this product.<BR><BR>To take advantage of the Wireless-N feature offered by the router, use a wireless adapter that displays this logo."
...
error_module="Error upgrade file module name! (Module name is \"R9000\") "
error_language_form="Incorrect upgrade file language name. (The language name is\"R9000-*-Language-table\".)"
